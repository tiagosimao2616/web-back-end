...
dotenv.config();
// SQL connection
const sequelize = new Sequelize(process.env.DB_SCHEMA,process.env.DB_HOST,process.env.DB_USER,process.env.DB_PASS {
...
app.get(
  ...
  function (request, response) {
    Employees.findAll().then((persons) => {
...
app.post("/employees", function (request, response) {
  ...
  if (body == undefined || []) {
    ...
    Employees.create(body).then((body) =>
